...
router.post('/ingest', sensitiveRateLimit, authMiddleware, requireFields(['userId', 'deviceId']), (req, res) => {
...
router.get('/daily-summary', sensitiveRateLimit, authMiddleware, (req, res) => {
