...
router.get('/', sensitiveRateLimit, authMiddleware, requireRole('admin'), (_req, res) => {
  return res.json({ users: getAllUsers() });
});

router.post('/:id/promote', sensitiveRateLimit, authMiddleware, requireRole('admin'), (req, res) => {
